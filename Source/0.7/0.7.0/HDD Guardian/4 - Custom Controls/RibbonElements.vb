...
Namespace MimicExplorer
    Public Class ExplorerTab
        ...
        Protected Overrides Sub OnPaint(pevent As PaintEventArgs)
            ...
            If Me.Checked Then
                pevent.Graphics.DrawRectangle(New Pen(border), New Rectangle(0, 0, Me.Width - 1, Me.Height))
                Me.FlatAppearance.MouseOverBackColor = selected
            Else
                If _mouseOver Then
                    pevent.Graphics.DrawRectangle(New Pen(back), New Rectangle(0, 0, Me.Width - 1, Me.Height))
                    pevent.Graphics.DrawRectangle(New Pen(inner), New Rectangle(1, 1, Me.Width - 3, Me.Height))
                    pevent.Graphics.DrawLine(New Pen(border), 0, Me.Height - 1, Me.Width - 1, Me.Height - 1)
                Else
                    pevent.Graphics.DrawLine(New Pen(border), 0, Me.Height - 1, Me.Width - 1, Me.Height - 1)
                End If
            End If
    ...
    Public Class RibbonRadio
        ...
        Protected Overrides Sub OnPaint(pevent As PaintEventArgs)
            ...
            If Me.Checked Then
                pevent.Graphics.FillRectangle(New SolidBrush(check), New Rectangle(-1, -1, Me.Width + 1, Me.Height + 1))
            Else
                If _mouseOver Then
                    pevent.Graphics.FillRectangle(New SolidBrush(over), New Rectangle(-1, -1, Me.Width + 1, Me.Height + 1))
                Else
                    pevent.Graphics.FillRectangle(New SolidBrush(Me.Parent.BackColor), New Rectangle(-1, -1, Me.Width + 1, Me.Height + 1))
                End If
            End If
    ...
    Public Class RibbonButton
        ...
        Protected Overrides Sub OnPaint(pevent As PaintEventArgs)
            ...
            If _mouseOver Then
                pevent.Graphics.FillRectangle(New SolidBrush(over), New Rectangle(-1, -1, Me.Width + 1, Me.Height + 1))
                If _mouseDown Then
                    pevent.Graphics.FillRectangle(New SolidBrush(down), New Rectangle(-1, -1, Me.Width + 1, Me.Height + 1))
                End If
            Else
                pevent.Graphics.FillRectangle(New SolidBrush(Me.Parent.BackColor), New Rectangle(-1, -1, Me.Width + 1, Me.Height + 1))
            End If
