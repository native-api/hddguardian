    ...
    Public Sub LoadAttribInfos()
        ...
        Else
            If FileIO.FileSystem.DirectoryExists(languagesfolder & AppSettings.Language.PreferredLanguage) Then
                If IO.File.Exists(languagesfolder & AppSettings.Language.PreferredLanguage & "\attributes.xml") Then
                    e_xmldoc.Load(languagesfolder & AppSettings.Language.PreferredLanguage & "\attributes.xml")
                    m_external = True
                End If
            End If
        End If
