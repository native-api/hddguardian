...
Public Class TrayPanel
    ...
    Public Sub SetPanel(ByVal Ssd As Boolean, ByVal model As String, ByVal location As String, ByVal rating As Device.Ratings, ByVal temperature As String, ByVal remaininglife As String, ByVal health As Status, ByVal type As DeviceType)
