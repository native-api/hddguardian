            ...
            If AppSettings.General.DisplayInfoPanel Then
                If Main.WindowState = FormWindowState.Minimized Then
                    ...
                    If TrayPanel.Visible Then
                        Exit Sub
                    Else
                        TrayPanel.SetPanel(m_ssd, m_model, devlocation, m_rating, m_temperature, m_remaininglife, m_health, devtype)
                        TrayPanel.Show(Main)
                    End If
                End If
            Else
...
#End Region
        ...
        Public Sub SetIcon()
            ...
            If IsNumeric(num) Then
                ...
                row = num.Substring(0, num.Length - 1)
                col = num.Substring(num.Length - 1, 1)
            ...
            'set icon
            Dim geticon As IntPtr = imgBack.Clone(New Rectangle(0, 0, 16, 16), imgBack.PixelFormat).GetHicon
