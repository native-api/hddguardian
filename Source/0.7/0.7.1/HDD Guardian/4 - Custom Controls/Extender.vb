...
Public Class BenchmarkBar
    ...
    Public Sub New()
        ...
        picValue.Parent = pnlBack
        picValue.Dock = DockStyle.Left
        picValue.Width = BenchToBar(curvalue)
        picValue.BackColor = c
    End Sub

    Private Sub RePaint() Handles MyBase.SizeChanged
        If curvalue = 0 Then picValue.Width = 0 Else picValue.Width = BenchToBar(Value)
    End Sub

    Private Function BenchToBar(ByVal value As Double) As Integer
        Dim b As Double = value * 253 / 1000
        Return CInt(b)
    End Function
