...
Public Class CustomSettings
    ...
    Public Sub ResetToDefault()
        ...
        With _vital
            ...
            .UncorrectedReads = SettingsVital.Vital.Complete
            .UncorrectedVerifies = SettingsVital.Vital.Complete
            .UncorrectedWrites = SettingsVital.Vital.Complete
            .Defects = SettingsVital.Vital.Complete
        End With
        With _warnings
        ...
        With _reliability
            ...
            .Defects = 20
            .UncorrectedWrites = 10
            .UncorrectedReads = 10
            .UncorrectedVerifies = 10
        End With
        With _sharing
            .OutputFolder = ""
            .XmlFolder = ""
...
#Region "Hidden (to Intellisense) classes"
    ...
    Public Class SettingsGeneral
        Dim _runMinimized, _hideToTray, _closeToTray, _alwaysDisplayIcon, _confirmOnExit, _rememberWindowSize,
    ...
    Public Class SettingsVital
        ...
        Dim _uncorrectedWrites, _uncorrectedReads, _uncorrectedVerifies, _scsiDefects As Vital
...
#Region "SCSI HDD"
        Public Property UncorrectedWrites As Vital
            Get
                Return _uncorrectedWrites
            End Get
            Set(value As Vital)
                _uncorrectedWrites = value
            End Set
        End Property

        Public Property UncorrectedReads As Vital
            Get
                Return _uncorrectedReads
            End Get
            Set(value As Vital)
                _uncorrectedReads = value
            End Set
        End Property

        Public Property UncorrectedVerifies As Vital
            Get
                Return _uncorrectedVerifies
            End Get
            Set(value As Vital)
                _uncorrectedVerifies = value
            End Set
        End Property

        Public Property Defects As Vital
            Get
                Return _scsiDefects
            End Get
            Set(value As Vital)
...
#End Region
    ...
    Public Class SettingsReliability
        ...
        Dim _scsiDefects, _scsiUncorrectedWrites, _scsiUncorrectedReads, _scsiUncorrectedVerifies As Short
        ...
        Public Property Defects As Short
            Get
                Return _scsiDefects
            End Get
            Set(value As Short)
        ...
        Public Property UncorrectedWrites As Short
            Get
                Return _scsiUncorrectedWrites
            End Get
            Set(value As Short)
                _scsiUncorrectedWrites = value
            End Set
        End Property

        Public Property UncorrectedReads As Short
            Get
                Return _scsiUncorrectedReads
            End Get
            Set(value As Short)
                _scsiUncorrectedReads = value
            End Set
        End Property

        Public Property UncorrectedVerifies As Short
            Get
                Return _scsiUncorrectedVerifies
            End Get
            Set(value As Short)
                _scsiUncorrectedVerifies = value
            End Set
        End Property
