...
#Region "Color scheme"
    Private Sub ColorScheme()
        ...
        For Each c In tlpGeneric.Controls
            c.ForeColor = cs.ForeColor
        Next
        For Each c In tlpAta.Controls
            c.ForeColor = cs.ForeColor
        Next
        For Each c In tlpSsd.Controls
            c.ForeColor = cs.ForeColor
        Next
        For Each c In tlpScsi.Controls
            c.ForeColor = cs.ForeColor
        Next
        'Warnings
    ...
    Public Sub LoadSettings()
        ...
        With AppSettings
            ...
            With .VitalParameters
                ...
                'SCSI
                cboDefects.SelectedIndex = .Defects
                cboUncReads.SelectedIndex = .UncorrectedReads
                cboUncVerifies.SelectedIndex = .UncorrectedVerifies
                cboUncWrites.SelectedIndex = .UncorrectedWrites
            End With
            ...
            With .Reliability
                ...
                If .Defects > 0 Then numDefects.Value = .Defects
                If .UncorrectedReads > 0 Then numUncReads.Value = .UncorrectedReads
                If .UncorrectedVerifies > 0 Then numUncVerifies.Value = .UncorrectedVerifies
                If .UncorrectedWrites > 0 Then numUncWrites.Value = .UncorrectedWrites
            End With
    ...
    Public Sub SaveSettings(ByVal who As String)
        ...
        With AppSettings
            ...
            With .VitalParameters
                ...
                'SCSI
                .Defects = cboDefects.SelectedIndex
                .UncorrectedReads = cboUncReads.SelectedIndex
                .UncorrectedVerifies = cboUncVerifies.SelectedIndex
                .UncorrectedWrites = cboUncWrites.SelectedIndex
            End With
            ...
            With .Reliability
                ...
                .Defects = numDefects.Value
                .UncorrectedReads = numUncReads.Value
                .UncorrectedVerifies = numUncVerifies.Value
                .UncorrectedWrites = numUncWrites.Value
            End With
...
#Region "General"
    ...
    Private Sub look_n_feel(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _
        chkRunMinimized.CheckedChanged, chkMinimizeInTray.CheckedChanged, chkCloseOnTray.CheckedChanged,
...
#Region "Vital parameters"
    Private Sub vitals(sender As Object, e As EventArgs) Handles cboTemp.SelectedIndexChanged, cboCurPenSect.SelectedIndexChanged,
        cboDiskShift.SelectedIndexChanged, cboIndilinx.SelectedIndexChanged, cboIntel.SelectedIndexChanged, cboMicron.SelectedIndexChanged,
        cboOfflUnc.SelectedIndexChanged, cboReallEvCt.SelectedIndexChanged, cboReallSectCt.SelectedIndexChanged, cboSamsung.SelectedIndexChanged,
        cboSandForce.SelectedIndexChanged, cboSoftReadErr.SelectedIndexChanged, cboSpinRetryCt.SelectedIndexChanged,
        cboDefects.SelectedIndexChanged, cboUncReads.SelectedIndexChanged, cboUncVerifies.SelectedIndexChanged, cboUncWrites.SelectedIndexChanged
...
#Region "Notifications"
    Private Sub notifications_actions(sender As Object, e As EventArgs) Handles cboPopUp.SelectedIndexChanged,
...
#Region "Reliability"
    ...
    Private Sub TunersValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _
        ...
        numDefects.ValueChanged, numUncReads.ValueChanged, numUncVerifies.ValueChanged, numUncWrites.ValueChanged

        'Main.SetRating()
        If Main.devlist.Count > 0 Then Main.ReliabilityDetails(Main.devlist(Main.lvwDevices.SelectedItems(0).Index))
        If Not isloading_settings Then SaveSettings(sender.name)
    End Sub
    ...
    Private Sub Reset(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles _
        ...
        lnkResetDefects.LinkClicked, lnkResetUncReads.LinkClicked, lnkResetUncVerifies.LinkClicked, lnkResetUncWrties.LinkClicked
        ...
        Select Case sender.Name
            ...
            Case lnkResetDefects.Name
                numDefects.Value = numDefects.Tag
            Case lnkResetUncReads.Name
                numUncReads.Value = numUncReads.Tag
            Case lnkResetUncVerifies.Name
                numUncVerifies.Value = numUncVerifies.Tag
            Case lnkResetUncWrties.Name
                numUncWrites.Value = numUncWrites.Tag
        End Select
    End Sub
...
#Region "RAID controllers"
    ...
    Private Sub numAreca_ValueChanged(sender As Object, e As EventArgs) Handles numArecaSata.ValueChanged, numArecaEnclosure1.ValueChanged,
        numArecaEnclosure2.ValueChanged, numArecaEnclosure3.ValueChanged, numArecaEnclosure4.ValueChanged, numArecaEnclosure5.ValueChanged,
...
#Region "Help icons"
    Private Sub Help_Click(sender As Object, e As EventArgs) Handles picHelpSetupGeneral.Click, picHelpSetupDetection.Click,
        picHelpSetupMailAlerts.Click, picHelpSetupMonitoring.Click,
        picHelpSetupRating.Click, picHelpSetupShare.Click, picHelpSetupTolerance.Click,
        picHelpSetupTranslation.Click, picHelpSetupUpdate.Click, picHelpSetupWarnings.Click, picHelpSetupControllers.Click,
        ...
        With Main.dlgFolder
            ...
            If result = DialogResult.OK Then
                ...
                If IO.File.Exists(.SelectedPath & "\smartctl.exe") Then
                    ...
                    Dim bundled() As String = prompt.Smartctl("-V")
                    Dim selected() As String = prompt.Smartctl("-V", .SelectedPath)
