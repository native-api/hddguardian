...
'
'home page: http://code.google.com/p/hddguardian/
'
...
Module Variables
    ...
    Friend life_ok As Color = Color.FromArgb(0, 180, 0)
    ...
    '*** attributes table colors ***
    Friend attribute_warning As Color = Color.DarkOrange
    Friend attribute_fail As Color = Color.Red
    Friend attribute_warning_light As Color = Color.Orange
    Friend attribute_fail_light As Color = Color.Firebrick
End Module
