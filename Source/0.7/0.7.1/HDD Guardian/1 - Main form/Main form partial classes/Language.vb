...
Partial Class Main
    ...
    Dim m_gathering, m_partition, m_disk As String
    ...
    Dim scsi_defects, scsi_uncReads, scsi_uncVerify, scsi_uncWrites As String
    'languages
    ...
    Friend Function GetString(ByVal value As Short) As String
        ...
        Return language(String.Format("{0:D4}", value)).ToString.Replace("\", vbCrLf)
    End Function

    Private Sub InterfaceTranslation()
        LoadLanguage()

        m_temperature = GetString(761)
        m_remaininglife = GetString(762)
        ...
        mnuDeviceImage.Text = GetString(116)
        mnuDeviceImageSet.Text = GetString(117)
        mnuDeviceImageRemove.Text = GetString(118)
        ...
        lnkUpdateDatabase.Text = GetString(743)
        'warnings
        ...
        'SCSI
        scsi_defects = GetString(3931)
        scsi_uncReads = GetString(3932)
        scsi_uncVerify = GetString(3933)
        scsi_uncWrites = GetString(3934)
        ...
        chValues.Text = GetString(1518)
        chRawValue.Text = GetString(1519)
        ...
        lblNoError.Text = GetString(1601)
        e_noerrorlogging = GetString(1604)
        lblErrorDescTitle.Text = GetString(1605)
        ...
        lvwScsiErrors.Groups(0).Header = GetString(2502)
        lvwScsiErrors.Groups(1).Header = GetString(2503)
        lvwScsiErrors.Groups(2).Header = GetString(2504)
        ...
        lblDiskIndex.Text = GetString(3201)
        lblDiskPartitions.Text = GetString(3202)
        lblDiskSize.Text = GetString(3203)
        lblDiskSN.Text = GetString(3205)
        lblLogicalSN.Text = GetString(3205)
        lblFileSystem.Text = GetString(3206)
        lblLogicalSize.Text = GetString(3203)
        lblBootable.Text = GetString(3210)
        lblBootPartition.Text = GetString(3211)
        lblPrimaryPartition.Text = GetString(3212)
        lblPartitionType.Text = GetString(3209)
        lblBlocks.Text = GetString(3207)
        lblBlockSize.Text = GetString(3208)
        lblPartitionSize.Text = GetString(3203)
        m_gathering = GetString(3213)
        lblHrwMotherboard.Text = GetString(3214)
        lblHrwProcessor.Text = GetString(3215)
        lblHrwRam.Text = GetString(3216)
        lblHrwVideoCard.Text = GetString(3217)
        lblHrwBios.Text = GetString(3222)
        m_disk = GetString(3218)
        m_partition = GetString(3219)
        m_yes = GetString(3220)
        m_no = GetString(3221)
        'benchmark
        lblBenchmark.Text = GetString(3240)
        lblSequentialMulti.Text = GetString(3241)
        lblRandomMulti.Text = GetString(3242)
        lblSequential.Text = GetString(3243)
        lblRandom.Text = GetString(3244)
        lnkRunAll.Text = GetString(3247)
        lblNoBench.Text = GetString(3249)
        lblBenching.Tag = GetString(3250)
        ...
        With SettingsForm
            ...
            With .cboProviders.Items
                ...
                .Add("Yahoo")
            End With
            .lnkLessSecure.Text = GetString(3781)
        ...
        With SettingsForm
            ...
            'generic parameters
            .tpGeneric.Text = GetString(3908)
            .lblVitalTemp.Text = GetString(3912)
            'hard disk drives
            .tpAta.Text = GetString(3902)
            ...
            'SCSI
            .tpScsi.Text = GetString(3906)
            .lblDefects.Text = GetString(3931)
            .lblUncReads.Text = GetString(3932)
            .lblUncVerifies.Text = GetString(3933)
            .lblUncWrites.Text = GetString(3934)
            ...
            .cboDefects.SelectedIndex = AppSettings.VitalParameters.Defects
            .cboUncReads.SelectedIndex = AppSettings.VitalParameters.UncorrectedReads
            .cboUncVerifies.SelectedIndex = AppSettings.VitalParameters.UncorrectedVerifies
            .cboUncWrites.SelectedIndex = AppSettings.VitalParameters.UncorrectedWrites
        End With
        ...
        With SettingsForm
            ...
            .lblAtaRating.Text = GetString(4212)
            ...
            .lblScsiRating.Text = GetString(4213)
            .lblDefectsTune.Text = GetString(4208) & ":"
            .lblUncReadsTune.Text = GetString(4209) & ":"
            .lblUncVerifiesTune.Text = GetString(4210) & ":"
            .lblUncWritesTune.Text = GetString(4211) & ":"
            .lnkResetDefects.Text = reset
            .lnkResetUncReads.Text = reset
            .lnkResetUncVerifies.Text = reset
            .lnkResetUncWrties.Text = reset
        End With
