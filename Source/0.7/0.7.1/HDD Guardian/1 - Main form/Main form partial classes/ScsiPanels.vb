...
Partial Class Main
    ...
    Public Sub PopulateScsiPanels()
        ...
        With lvwScsiErrors
            If d.Scsi.ErrorLog.HasLog Then
                ...
                If d.Scsi.ErrorLog.Read.HasData Then
                    .Items.Add(m_scsiecc & " (" & m_scsifast.ToLower & ")")
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Read.EccFast), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(0)

                    .Items.Add(m_scsiecc & " (" & m_scsidelayed.ToLower & ")")
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Read.EccDelayed), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(0)

                    .Items.Add(m_scsiecc & " (" & m_scsirrrw.ToLower & ")")
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Read.EccReReadReWrites), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(0)

                    .Items.Add(m_scsicorrected)
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Read.ErrorsCorrected), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(0)

                    .Items.Add(m_scsialgorithm)
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Read.CorrectionAlgorithmInvocations), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(0)

                    .Items.Add(m_scsigb)
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Read.GbProcessed), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(0)

                    .Items.Add(m_scsiuncorrected)
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Read.UncorrectedErrors), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(0)
                End If
                If d.Scsi.ErrorLog.Write.HasData Then
                    .Items.Add(m_scsiecc & " (" & m_scsifast.ToLower & ")")
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Write.EccFast), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(1)

                    .Items.Add(m_scsiecc & " (" & m_scsidelayed.ToLower & ")")
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Write.EccDelayed), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(1)

                    .Items.Add(m_scsiecc & " (" & m_scsirrrw.ToLower & ")")
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Write.EccReReadReWrites), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(1)

                    .Items.Add(m_scsicorrected)
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Write.ErrorsCorrected), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(1)

                    .Items.Add(m_scsialgorithm)
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Write.CorrectionAlgorithmInvocations), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(1)

                    .Items.Add(m_scsigb)
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Write.GbProcessed), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(1)

                    .Items.Add(m_scsiuncorrected)
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Write.UncorrectedErrors), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(1)
                End If
                If d.Scsi.ErrorLog.Verify.HasData Then
                    .Items.Add(m_scsiecc & " (" & m_scsifast.ToLower & ")")
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Verify.EccFast), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(2)

                    .Items.Add(m_scsiecc & " (" & m_scsidelayed.ToLower & ")")
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Verify.EccDelayed), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(2)

                    .Items.Add(m_scsiecc & " (" & m_scsirrrw.ToLower & ")")
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Verify.EccReReadReWrites), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(2)

                    .Items.Add(m_scsicorrected)
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Verify.ErrorsCorrected), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(2)

                    .Items.Add(m_scsialgorithm)
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Verify.CorrectionAlgorithmInvocations), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(2)

                    .Items.Add(m_scsigb)
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Verify.GbProcessed), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(2)

                    .Items.Add(m_scsiuncorrected)
                    .Items(.Items.Count - 1).SubItems.Add(Format(Val(d.Scsi.ErrorLog.Verify.UncorrectedErrors), "#,##0"))
                    .Items(.Items.Count - 1).Group = .Groups(2)
                End If
                .Visible = True
            Else
        ...
        End With
        '*** run test ***
        pnlScsiTestRun.Visible = d.Scsi.Test.IsRunning
