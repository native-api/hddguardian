...
Partial Class Main
    ...
    Private Sub InterfaceTranslation()
        ...
        robTemperatures.Text = GetString(306)
        'device setup
        ...
        robAdvanced.Text = GetString(335)
        ...
        hdd_reallevents = GetString(3913)
        ...
        '*** temperatures ***
        '********************
        lblAdminTemperatures.Text = GetString(5110)
        ...
        '**********************************
        lblAdminAdvanced.Text = GetString(5112)
        ...
        With Settings
            ...
            .robControllers.Text = GetString(3313)
            .robSmartctl.Text = GetString(3312)
        End With
        ...
        With Settings
            ...
            .tpTriggers.Text = GetString(3772)
            ...
            Next
            .cboDays.SelectedIndex = My.Settings.MailDayNumber
        ...
        With Settings
            ...
            'generic parameters
            .grpGeneric.Text = GetString(3905)
            .chkTemp.Text = GetString(3912)
            'hard disk drives
            .grpHdd.Text = GetString(3902)
        ...
        With Settings
            ...
            .chkParamChng.Text = GetString(4010)
            .nlChooseParams.Text = GetString(4011)
            .lblWarningsPath.Text = GetString(3308) & " › " & GetString(4012)
            .nlBackToWarnings.Text = GetString(4013)
            'generic parameters
            .grpGenericChange.Text = GetString(3905)
            .chkTempChng.Text = GetString(3912)
            'hard disk drives
            .grpHddChange.Text = GetString(3902)
            ...
            'solid state devices
            .grpSsdChange.Text = GetString(3903)
