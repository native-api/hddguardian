...
#Region "UTX Theme call"
    ...
    Public Sub New()
        ...
        If My.Settings.RememberWindowSize Then Me.Size = New Size(My.Settings.WindowSize)
    End Sub
#End Region
...
#Region "Main form"
    ...
    Private Sub frmMain_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Deactivate
        ...
        If My.Settings.MinimizeOnTray Then
            ...
            Else
                ...
                Me.Visible = True
                If Not IsNothing(niTrayIcon) And Not Me.Disposing Then niTrayIcon.Visible = My.Settings.AlwaysShowTrayIcon
            End If
        End If
    ...
    Private Sub Main_ResizeEnd(sender As Object, e As EventArgs) Handles Me.ResizeEnd
        If My.Settings.RememberWindowSize Then
            If Me.WindowState <> FormWindowState.Minimized Then My.Settings.WindowSize = Me.Size
...
#Region "File menu items"
    ...
    Private Sub mnuUpdateDatabase_Click(sender As Object, e As EventArgs) Handles mnuUpdateDatabase.Click
        If My.Settings.SmartctlAlternative Then
            If System.IO.File.Exists(My.Settings.SmartctlFolder & "\smartctl\update-smart-drivedb.exe") Then
                Shell(My.Settings.SmartctlFolder & "\smartctl\update-smart-drivedb.exe", AppWinStyle.NormalFocus, False)
            End If
        Else
...
#Region "Devices list"
        ...
        Try
            ...
            If e.Button = MouseButtons.Right And Not IsNothing(lvItem) Then
                ...
                If devlist(lvItem.Index).Type <> DeviceType.Threeware Then
                    mnuTitle.Text = devlist(lvItem.Index).Model
                Else
    ...
    Private Sub lvwDevices_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles lvwDevices.MouseDoubleClick
        ...
        If Not IsNothing(lvItem) Then
            rmiOverview.Deselect()
            InvokeOnClick(rmiManage, Nothing)
        End If
    End Sub
...
#Region "Virtual devices"
    ...
    Private Sub mnuRemoveVirtual_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuRemoveVirtualDev.Click
        ...
        End With
        Debug.Print(virtualfolder & devlist(i).DeviceFileName & ".vd")
...
#Region "Xml"
    ...
    Private Sub mnuXmlCreate_Click(sender As Object, e As EventArgs) Handles mnuXmlCreate.Click
        ...
        Settings.chkXml.Checked = mnuXmlCreate.Checked
        Settings.btnXml.Enabled = mnuXmlCreate.Checked
...
#Region "Manage: device selection"
    ...
    Private Sub cboDevices_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboDevices.SelectedIndexChanged
        ...
        If devlist(cboDevices.SelectedIndex).IsScsi Then
            MoveToScsi()
            PopulateScsiPanels()
            If devlist(cboDevices.SelectedIndex).TestIsRunnig Then
    ...
    Public Sub DisableSections()
        ...
        If d.Type = DeviceType.Threeware And Not d.IsValidDevice Then
            For Each Control In tlpInfo.Controls
        ...
        If d.Type = DeviceType.Threeware Then
            robEventsChart.Enabled = False
            robEventsLog.Enabled = False
            robTemperatures.Enabled = False
            For Each Control In tlpSetup.Controls
                Control.Enabled = False
            Next
            robRunTest.Enabled = False
            robAdvanced.Enabled = False
        End If
    ...
    Public Sub MoveToScsi()
        'info
        If robAttributes.Checked Or robTemperatures.Checked Then InvokeOnClick(robInfo, Nothing)
        ...
        'smartctl
        If robAdvanced.Checked Then InvokeOnClick(robOutput, Nothing)
    End Sub
...
#Region "Info"
    Private Sub robInfo_Click(sender As Object, e As EventArgs) Handles robInfo.Click
        ...
        picManageHelp.Tag = My.Resources.help_device_information
    End Sub
    ...
    Private Sub robHealth_Click(sender As Object, e As EventArgs) Handles robHealth.Click
        ...
        picManageHelp.Tag = My.Resources.help_device_health
    End Sub
    ...
    Private Sub robEventsLog_Click(sender As Object, e As EventArgs) Handles robEventsLog.Click
        ...
        picManageHelp.Tag = My.Resources.help_events_log
    End Sub
    ...
    Private Sub robTemperatures_Click(sender As Object, e As EventArgs) Handles robTemperatures.Click
        If Not htcManage.SelectedTab Is tpInfo Then
            htcManage.SelectPage(tpInfo)
            DeselectSection(Sections.Setup)
            DeselectSection(Sections.ErrorsTests)
...
#Region "Errors and tests"
    ...
    Private Sub robRunTest_Click(sender As Object, e As EventArgs) Handles robRunTest.Click
        ...
        If d.IsScsi Then
            ...
            If Not d.Type = DeviceType.Virtual Then tlpScsiTest.Visible = True
        Else
            htcErrorsTests.SelectPage(tpAtaRunTest)
            If Not d.Type = DeviceType.Virtual Then tlpTest.Visible = True
        End If
...
#Region "Smartctl"
    ...
    Private Sub robAdvanced_Click(sender As Object, e As EventArgs) Handles robAdvanced.Click
        If Not htcManage.SelectedTab Is tpSmartctl Then
            htcManage.SelectPage(tpSmartctl)
            DeselectSection(Sections.Info)
            DeselectSection(Sections.Setup)
...
#Region "Debug"
    ...
    Private Sub rbtClean_Click(sender As Object, e As EventArgs) Handles rbtClean.Click
