...
Partial Class Device
    ...
    Private m_isscsidisk As Boolean = False
    ...
    Private m_scsiworktime As String = "N/A"
    Private m_scsiworktimehuman As String
    ...
    Private Sub GetScsiAttributes()
        ...
        Try
            ...
            For i As Short = 0 To m_output.Length - 2
                If m_output(i).Contains("number of hours powered up") Then
                    Dim t() As String = m_output(i).Split("=")
                    ScsiWorkTime(t(1).Trim)
                    Exit For
                End If
            Next
    ...
    Private Sub ScsiWorkTime(ByVal wt As String)
        Dim t As Integer
        If wt.Contains(".") Then
        ...
        If t = 1 Then
            m_scsiworktime = t & " " & Main._h
        Else
            m_scsiworktime = t & " " & Main._hh
        End If
