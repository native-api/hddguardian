...
Public Class TrayPanel
    ...
    Public Sub SetPanel(ByVal model As String, ByVal location As String, ByVal rating As Ratings, ByVal temperature As String, ByVal remaininglife As String, ByVal health As Status, ByVal type As DeviceType)
            ...
            If Not IsNothing(model) Then
                ...
                If re.Match(model).Success Then
                    If type = DeviceType.USB Then
                        picDeviceImage.BackgroundImage = Main.manufacturersList(i).External
                    Else
                        picDeviceImage.BackgroundImage = Main.manufacturersList(i).Internal
                    End If
                    Exit For
                End If
            End If
