...
Public Class AddVirtual
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        Dim devfilename As String = devmodel & "_" & serial
        devfilename = devfilename.Replace("""", "").Replace("?", "").Replace("\", "").Replace("|", "").Replace(":", "").Replace("*", "") _
            .Replace("/", "").Replace(">", "").Replace("<", "")

        IO.File.WriteAllText(virtualfolder & devfilename & ".vd", content, System.Text.Encoding.Default)
