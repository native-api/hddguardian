...
Partial Class Main
    ...
    Private Sub Search()
        ...
        If Not My.Settings.IgnoreCsmi Then
    ...
    Private Sub CollectDevices()
        ...
        If Not IsNothing(win8devices) Then
            PrintDebug("*** Adding Windows 8 Storage Sapces Controller devices ***", False, True)
        ...
        If Not IsNothing(usbdevices) Then
            ...
            For d As Integer = 0 To usbdevices.Count - 1
                ...
                If usb.IsDoubleDeck Then
                    PrintDebug("Detected double deck device", False, True)
        ...
        'try to detect multiple dock devices...
        'If My.Settings.MultiDock Then ScanMultiDock()
