        ...
        With txtConsole
            ...
            If Not IsNothing(int_devices) Then
                ...
                For i As Short = 0 To int_devices.Length - 1
                    ...
                    .AppendText("smartctl -a -g all -g wcreorder -P use " & int_devices(i) & vbCrLf)
                    .AppendText(vbCrLf)
                    .AppendText(prompt.SendCmd("-a -g all -g wcreorder -P use " & int_devices(i)))
                    .AppendText(vbCrLf)
                Next i
            Else
            ...
            If Not IsNothing(ext_devices) Then
                ...
                For i As Short = 0 To ext_devices.Length - 1
                    ...
                    .AppendText("::: Scan device " & name(0) & " :::" & vbCrLf)
                    .AppendText("smartctl -a -g all -g wcreorder -P use " & ext_devices(i) & vbCrLf)
                    .AppendText(vbCrLf)
                    .AppendText(prompt.SendCmd("-a -a -g all -g wcreorder -P use " & ext_devices(i)))
                    .AppendText(vbCrLf)
                Next i
            ...
            If Not IsNothing(csmi_devices) Then
                ...
                For i As Short = 0 To csmi_devices.Length - 1
                    ...
                    .AppendText("::: Scan device " & name(0) & " :::" & vbCrLf)
                    .AppendText("smartctl -a -g all -g wcreorder -P use " & csmi_devices(i) & vbCrLf)
                    .AppendText(vbCrLf)
                    .AppendText(prompt.SendCmd("-a -a -g all -g wcreorder -P use " & csmi_devices(i)))
                    .AppendText(vbCrLf)
                Next i
