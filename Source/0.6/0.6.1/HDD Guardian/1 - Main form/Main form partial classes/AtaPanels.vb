        ...
        With lblErrorsAta
            If Not IsNothing(dev.Errors) Then
                Select Case Val(dev.TotalErrors)
                    ...
                    Case Is > 10
                        .ForeColor = status_fail
                        .Text = error_several.Replace("%", dev.TotalErrors)
                End Select
            Else
                .ForeColor = status_unknown
                .Text = "N/A"
                ...
                For Item As Short = 0 To lvwSmart.Items.Count - 1
                    ...
                    If idname = "Reallocated Sector Ct" Or _
                        ...
                        If IsNumeric(.Items(Item).SubItems(6).Text) Then
                            If Convert.ToSingle(.Items(Item).SubItems(6).Text) > 0 And .Items(Item).ForeColor = Color.Black Then
                        ...
                        If .Items(Item).SubItems(6).Text.Contains("(") Then
                            ...
                            If Convert.ToSingle(v(0).Trim) > 0 And .Items(Item).ForeColor = Color.Black Then
                                .Items(Item).ForeColor = Color.DeepPink
                                .Items(Item).ImageIndex = 3
        ...
        Select Case cboTest.SelectedIndex
            Case 0
                ...
                If IsNumeric(t(0)) Then
                    Dim polltime As Integer = Val(t(0))
                    Dim h As Integer = Val(t(0)) \ 3600
                    Dim m As Integer = (Val(t(0)) - h * 3600) \ 60
                    Dim s As Integer = Val(t(0)) - h * 3600 - m * 60
            ...
            Case 1
                ...
                If IsNumeric(t(0)) Then
                    Dim polltime As Integer = Val(t(0))
                    Dim h As Integer = Val(t(0)) \ 60
                    Dim m As Integer = Val(t(0)) - h * 60
